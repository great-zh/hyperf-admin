...
class AdminRelationship extends BaseModel
{
    ...
    /** @var string 多对多 */
    public const TYPE_BELONGS_TO_MANY = 'BELONGS_TO_MANY';

    /** @var string 远程一对一 */
    public const TYPE_HAS_ONE_THROUGH = 'HAS_ONE_THROUGH';

    /** @var string 远程一对多 */
    public const TYPE_HAS_MANY_THROUGH = 'HAS_MANY_THROUGH';

    /** @var string 一对一(多态) */
    public const TYPE_MORPH_ONE = 'MORPH_ONE';

    /** @var string 一对多(多态) */
    public const TYPE_MORPH_MANY = 'MORPH_MANY';

    /** @var string 多对多(多态) */
    public const TYPE_MORPH_TO_MANY = 'MORPH_TO_MANY';
